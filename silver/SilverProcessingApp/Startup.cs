...
namespace SilverProcessingApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddIdentity<SilverProcessingAppUser, IdentityRole>()
                .AddDefaultUI()
                .AddEntityFrameworkStores<SilverProcessingAppContext>().AddDefaultTokenProviders();
        }
